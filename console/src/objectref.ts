...
const KINDS: readonly ObjectKind[] = ['tier', 'service', 'blueprint', 'component', 'team']
 ...
 * Blueprints open in Compose, Components in Catalogue & Governance, and a
 * team lands on its shelf section.
 */
