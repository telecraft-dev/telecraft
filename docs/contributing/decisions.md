...
description: The ADR process, why an accepted ADR is amended rather than edited, the traceability matrix, and a themed map of the 47 ADRs.
order: 6
---
...
| Path | What it is |
|---|---|
| `docs/adr/` | The decision corpus: 47 records, ADR-0000 to ADR-0046. Normative. This is what code is measured against. |
