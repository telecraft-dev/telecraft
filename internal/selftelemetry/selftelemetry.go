...
//     id exactly as rendered. This is the primary key family, default-on and what
...
//
// R-4's caveats §5.1 to §5.7 are modelled as expected shapes, never join
...
type Reading struct {
	...
	// the surface drops it (the `otlp` receiver, R-4 §5.2), because signal for
